...
int32_T Enhanced_BMS_7ded21a_1_ds_imin ( const NeDynamicSystem * LC , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { ( void ) t1 ; ( void )
LC ; out -> mIMIN . mX [ 0 ] = - pmf_get_inf ( ) ; out -> mIMIN . mX [ 1 ] =
...
) ; out -> mIMIN . mX [ 53 ] = - pmf_get_inf ( ) ; ( void ) LC ; ( void ) out
; return 0 ; }
